...
unsigned int sf_untitled_process_testpoint_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (!strcmp(machineName, "untitled")) {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        extern mxArray *sf_c3_untitled_get_testpoint_info(void);
        plhs[0] = sf_c3_untitled_get_testpoint_info();
        break;
      }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4270008241U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2054463888U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3803448283U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(713322998U);
  }
